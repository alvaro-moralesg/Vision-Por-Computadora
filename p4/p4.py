...
def slct (event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        print("Realizo una seleccion. Presione 'g' para guardar la imagen seleccionada. Presione 'r' para volver a seleccionar.")
...
while (1): 
    ...
    if k == ord('q'):
        ...
        if k == ord('r'):
            ...
            except: print('Error al guardar la imagen. Intentar nuevamente.')           #Error que ocurre cuando se selecciona un punto o una linea
